...
const ContactFormSettings: React.FC<Props> = ({ router: { navigate } }) => {
    ...
    const [recipientSubjectTooltipOpen, setRecipientSubjectTooltipOpen] = React.useState(false);
    ...
    const getInitialFormValues = React.useCallback((metaData: IPageMetaData[]) => {
                                                    ...
                                                    <FormGroup tag="fieldset">
                                                        ...
                                                        <Col md={12}>
                                                            ...
                                                            <Tooltip
                                                                ...
                                                                toggle={() => setSenderMessageTooltipOpen((prev) => !prev)}
                                                            >
                                                        ...
                                                        <Col md={12}>
                                                            <FormGroup className='has-validation'>
                                                                ...
                                                                <Tooltip
                                                                    ...
                                                                    toggle={() => setRecipientSubjectTooltipOpen((prev) => !prev)}
                                                                >
                                                        ...
                                                        <Col md={12}>
                                                            <FormGroup className='has-validation'>
                                                                ...
                                                                <Tooltip
                                                                    ...
                                                                    toggle={() => setRecipientMessageTooltipOpen((prev) => !prev)}
                                                                >
