...
interface IState {
    dropdowns: Record<'earnings' | 'revenue', boolean>;
}
                    ...
                    <Col lg={7} xl={8}>
                        <Card>
                            <CardHeader className="py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <Dropdown className='no-arrow' isOpen={dropdowns.earnings} toggle={() => this.setState((prevState) => ({ dropdowns: { ...prevState.dropdowns, earnings: !prevState.dropdowns.earnings } }))}>
                    ...
                    <Col lg={5} xl={4}>
                        <Card className="shadow mb-4">
                            ...
                            <CardHeader className="py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <Dropdown className='no-arrow' isOpen={dropdowns.revenue} toggle={() => this.setState((prevState) => ({ dropdowns: { ...prevState.dropdowns, revenue: !prevState.dropdowns.revenue } }))}>
                                    <DropdownToggle caret tag='a' href='#'>
                                        <FaEllipsisV className="fa-sm fa-fw text-gray-400" />
                                    </DropdownToggle>
