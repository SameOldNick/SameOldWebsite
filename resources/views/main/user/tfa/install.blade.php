<x-main.layout class="page-user-tfa-install">
                ...
                <div class="card card-container shadow-lg bg-light mt-3">
                    ...
                    <div class="card-body">
                        <div class="px-5 py-4">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#panelsAuthSetup-qrCode" aria-expanded="true"
                                            aria-controls="panelsAuthSetup-qrCode">
                                            Option A (QR Code):
                                        </button>
                                    </h2>
                                    <div id="panelsAuthSetup-qrCode" class="accordion-collapse collapse show">
                                        <div class="accordion-body">
                                            ...
                                            <ol>
                                                <li>Download and install a multi-factor authenticator app (i.e.: Google
                                                    Authenticator) on your mobile device.</li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#panelsAuthSetup-setupKey"
                                            aria-expanded="false" aria-controls="panelsAuthSetup-setupKey">
                                            Option B (Setup Key):
                                        </button>
                                    </h2>
                                    <div id="panelsAuthSetup-setupKey" class="accordion-collapse collapse">
                                        <div class="accordion-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="formGroupAccountName" class="form-label">Account
                                                    Name</label>
                                                <input type="text" readonly class="form-control"
                                                    id="formGroupAccountName" value="{{ $accountName }}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formGroupSecret" class="form-label">Secret Key</label>
                                                <input type="text" readonly class="form-control" id="formGroupSecret"
                                                    value="{{ $secret }}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formGroupKeyType" class="form-label">Type of Key</label>
                                                <input type="text" readonly class="form-control"
                                                    id="formGroupKeyType" value="Time based">
                                            </div>
                            ...
                            <form
                                action="{{ URL::temporarySignedRoute('user.security.mfa.confirm-mfa', now()->addMinutes(30)) }}"
                                method="post" class="row justify-content-center mb-3">
                                @csrf
                                <div class="col-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="code" id="code" class="form-control"
                                            ...
                                            aria-label="{{ __('Enter Authenticator Code') }}" autocomplete="off"
                                            required>
                                    </div>
                                </div>
                                <div class="col-auto">
